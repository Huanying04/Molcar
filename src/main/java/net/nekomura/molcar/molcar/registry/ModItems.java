...
public class ModItems {
    ...
    public static final Item LETTUCE = new Item(new Item.Settings().group(ItemGroup.FOOD).maxCount(64).food(new FoodComponent.Builder().hunger(2).snack().build()));
    ...
    public static void register() {
        Registry.register(Registry.ITEM, new Identifier(Molcar.MOD_ID, "lettuce"), LETTUCE);
